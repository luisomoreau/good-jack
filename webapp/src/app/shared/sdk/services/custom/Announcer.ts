...
/**
 * Api services for the `Announcer` model.
 */
@Injectable()
export class AnnouncerApi extends BaseLoopBackApi {
  ...
  /**
   * Queries accessTokens of announcer.
   *
   * @param {any} id announcer id
   *
   * @param {object} filter 
  ...
  /**
   * Counts accessTokens of announcer.
   *
   * @param {any} id announcer id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/announcers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries campaigns of announcer.
   *
   * @param {any} id announcer id
   *
   * @param {object} filter 
  ...
  /**
   * @ngdoc method
   * @name sdk.Announcer#getCurrent
   * @methodOf sdk.Announcer
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/announcers" + "/:id";
   ...
   * call to {@link sdk.Announcer#login} or
   * {@link sdk.Announcer#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Announcer#login}
   *
  ...
  /**
   * @name sdk.Announcer#isAuthenticated
   *
  ...
  /**
   * @name sdk.Announcer#getCurrentId
   *
